...
class Task_7_1_4Test {
    ...
    void testStackTrace() {
        ...
        assertEquals("Task_7_1_4Test#testStackTrace", result);
    }

    @Test
    void testCorrectMethodNameDisplayed() {
        String result = helperMethod();
        assertEquals("Task_7_1_4Test#helperMethod", result);
    }

    @Test
    void testIncorrectMethodName() {
        String result = callerMethod();
        assertNotEquals("Task_7_1_4Test#testCorrectMethodNameDisplayed", result);
        assertEquals("Task_7_1_4Test#testIncorrectMethodName", result);
